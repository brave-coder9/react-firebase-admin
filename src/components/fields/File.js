...
class File extends Component {
  ...
  render() {
    ...
    return (
      <div>
      <br />
      <a href={imgSrc} className={this.props.class+" form-control"} target="_blank">{imgSrc}</a>
      <div className="fileinput fileinput-new text-center" data-provides="fileinputaa">
        <div>
            <span className="btn btn-rose btn-round btn-file">
                ...
                <input type="file" id={this.props.theKey} name={this.props.theKey}  onChange={this.handleChangeFile} />
            </span>
